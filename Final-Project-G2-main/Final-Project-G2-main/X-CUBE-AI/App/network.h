...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "mod_for_real"
...
#define AI_NETWORK_IN_1_CHANNEL     (288)
...
#define AI_NETWORK_OUT_1_CHANNEL     (14)
#define AI_NETWORK_OUT_1_SIZE        (14)
#define AI_NETWORK_OUT_1_SIZE_BYTES  (56)
